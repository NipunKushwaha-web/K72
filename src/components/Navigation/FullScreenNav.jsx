...
const FullScreenNav = () => {
    ...
    function gsapAnimation() {
        ...
        tl.set('.fullscreennav', {
            display: 'block',
            onStart: () => {
                const elem = document.getElementById('fullscreennav')
                if (elem) {
            ...
            <div ref={fullNavLinksRef} className='relative'>
                ...
                <div className='py-36'>
                    {[
                        ...
                        { title: 'Agence' },
                        { title: 'Contact' },
                        { title: 'Blogs', last: true }
                    ].map((item) => (
                        <div
                            key={item.title}
                            className={`link origin-top relative ${item.last ? 'border-y' : 'border-t'} border-white`}
                        >
                            ...
                            <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50]'>
                                {[0, 1].map(i => (
                                    <div className='moveX flex items-center' key={i}>
